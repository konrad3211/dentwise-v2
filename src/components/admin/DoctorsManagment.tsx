...
//advanced react, ale dlaczeo?  //bez tego react po otworzeniu nowego dialogu montowałby ten sam komponent co przed chwila ze starymi danymi, ale jakbym chciał zapisać ten edit to zapisałby na tego właściwego doktora
//Nie musimy tam uzywac key, ale jak uzywamy go to wymusza to na react montowanie nowego kompnentu
